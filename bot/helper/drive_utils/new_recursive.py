...
from bot import R_DRIVE_NAMES, R_DRIVE_IDS, R_INDEX_URLS, telegraph_token
...
class GoogleDriveHelper:
    ...
    def drive_list(self, fileName):
                ...
                for file in response:
                    ...
                    if x:
                        ...
                        if add_drive_title == True:
                            msg += f"╾────────────╼<br><b>{R_DRIVE_NAMES[INDEX]}</b><br>╾────────────╼<br>"
        ...
        for content in self.telegraph_content :
            self.path.append(telegra_ph.create_page(title = 'Jusidama',
